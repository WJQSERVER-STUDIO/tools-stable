...
#Gitea
function gitea(){
    wget -O gitea.sh ${repo_url}program/gits/gitea.sh && chmod +x gitea.sh && ./gitea.sh
}

#Gogs
function gogs(){
    wget -O gogs.sh ${repo_url}program/gits/gogs.sh && chmod +x gogs.sh && ./gogs.sh
}

# GitLab
function gitlab(){
    wget -O gitlab.sh ${repo_url}program/gits/gitlab.sh && chmod +x gitlab.sh && ./gitlab.sh
}
