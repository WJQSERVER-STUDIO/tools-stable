...
function serverstatus(){
    wget -O serverstatus.sh ${repo_url}program/monitor/serverstatus.sh && chmod +x serverstatus.sh && ./serverstatus.sh
}

#哪吒探针
function nezha(){
    wget -O nezha.sh ${repo_url}program/monitor/nezha.sh && chmod +x nezha.sh && ./nezha.sh
}
